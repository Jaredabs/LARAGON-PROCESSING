...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="mostrargrafico">
            <canvas id="grafico1">canvas es lienzo en blanco</canvas>
        ...
        <script>
            ...
            let etiquetas = datos.map((_, i) => "Valor " + (i + 1));//MAP hace, Para el dato número 0, escribe 'Valor 1'. Para el dato número 1, escribe 'Valor 2'"
            //grafico 1
            const chartBar = new Chart(document.getElementById('grafico1'),{
                type: 'bar',
                data:{
                    labels: etiquetas,//texto de el numero de valor
                    datasets:[{
                        label:'Sensor 1',//titulo
                        data:datos,//dato de arduino
                        borderWidth:2//grueso barra
                    }]
                },
            ...
            setInterval(async() => {
              try{
                ...
                let nuevoLabels = nuevodato.map((_,i) => "Dato" +(i + 1));
                //grafico 1
                ...
                chartLine.update();
                //grafico 3
                //chartPie.data.labels = nuevoLabels;
                chartPie.data.datasets[0].data = nuevodato;
                chartPie.update();
                //grafico 4
                //chartDona.data.labels = nuevoLabels;
